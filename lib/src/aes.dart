...
class _Aes {
  ...
  Uint32List _w = Uint32List(4); // _Nb*(_Nr+1) 32-bit words
  ...
  void aesSetKeys(Uint8List key, [Uint8List? iv]) {
    ...
    } else if (_aesMode != AesMode.ecb && (iv == null || iv.isEmpty)) {
      throw AesCryptArgumentError(
  ...
  Uint8List aesEncrypt(Uint8List data) {
    ...
    if (_aesMode != AesMode.ecb && (_aesIV == null || _aesIV!.isEmpty)) {
      throw AesCryptArgumentError(
