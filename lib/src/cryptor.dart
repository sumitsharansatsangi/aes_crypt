...
class _Cryptor {
  ...
  Uint8List decryptDataFromFileSync(String srcFilePath) {
    assert(!(_passBytes == null || _passBytes!.isEmpty));
...
//****************************************************************************
  ...
  Uint8List sha256(Uint8List data, [Uint8List? hmacIpad]) {
    ...
    Uint8List chunkLast;
    Uint8List chunkLastPre = Uint8List(4);
    int chanksToProcess;
...
//****************************************************************************
  ...
  void _encryptDataAndCalculateHmac(
    ...
    assert(iv.isNotEmpty, 'AES encryption key is null or empty.');
    assert(key.isNotEmpty, 'AES initialization vector is null or empty.');
